...
/******/ 	return __webpack_require__(__webpack_require__.s = "c8ce");
/******/ })
/************************************************************************/
/******/ ({
...
// CONCATENATED MODULE: ./components/BigImagePanel.js
...
var BigImagePanel_BigImagePanel =
/*#__PURE__*/
function (_Component) {
  Object(inherits["a" /* default */])(BigImagePanel, _Component);

  function BigImagePanel(props) {
    var _this;

    Object(classCallCheck["a" /* default */])(this, BigImagePanel);

    _this = Object(possibleConstructorReturn["a" /* default */])(this, Object(getPrototypeOf["a" /* default */])(BigImagePanel).call(this, props));
    _this.state = {};
    return _this;
  }

  Object(createClass["a" /* default */])(BigImagePanel, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
      ...
      return external_react_default.a.createElement("div", {
        ...
        id: "bigImagePanel-header"
      }, external_react_default.a.createElement("img", {
        src: logo_default.a,
        alt: "admix"
      })), external_react_default.a.createElement("div", {
        id: "bigImagePanel-title",
        className: "st"
      }, external_react_default.a.createElement("div", null, title)), external_react_default.a.createElement("div", {
        id: "bigImagePanel-forms"
      }, children), external_react_default.a.createElement("div", {
        id: "bigImagePanel-nav",
        className: "mb"
      }, footer)), external_react_default.a.createElement("div", {
        className: "bg-back-forth"
      }));
    }
  }]);
...
/* harmony default export */ var components_BigImagePanel = (BigImagePanel_BigImagePanel);
...
var _login = actions["a" /* default */].login;
...
var login_Login = function Login(_ref) {
  ...
  var renderFooter = function renderFooter() {
    return external_react_default.a.createElement("div", null, external_react_default.a.createElement("span", null, "Text"));
  };
  ...
  var validate = function validate(values) {
    ...
    if (!email || !isEmail_default()(email)) {
  ...
  if (isLoggedIn) {
    router_default.a.push("/campaigns");
    return null;
  }

  return external_react_default.a.createElement(App["a" /* default */], null, external_react_default.a.createElement(components_BigImagePanel, {
    title: "Login",
    footer: renderFooter()
    ...
    return external_react_default.a.createElement(external_formik_["Form"], null, external_react_default.a.createElement(TextInput["a" /* default */], Object(esm_extends["a" /* default */])({
      name: "email",
      label: "Email"
    }, formProps)), external_react_default.a.createElement(TextInput["a" /* default */], Object(esm_extends["a" /* default */])({
      name: "password",
      label: "Password"
    }, formProps)), external_react_default.a.createElement("button", {
      type: "submit",
...
login_Login = Object(external_react_redux_["connect"])(login_mapStateToProps, mapDispatchToProps)(login_Login);
...
module.exports = "/_next/static/images/logo-96b4d3e5e08ee70d9726151e09fc94a8.png";
